...
if($_POST['phone']) {
  ...
  if ($_POST['doc_type_val'] == 'sts') {
	...
	$price_1 = $_POST['itog_price_1'] / 100;
	$price_2 = $_POST['itog_price_2'] / 100;
	$price_3 = $_POST['itog_price_3'] / 100;
	$ip = get_ip();
}
...
$msg .= $_POST['itogs'];
$msg .= "<div style='height=20px;'>------------------------------------------------------------</div>";
$msg .= "<p><strong>Цена Россгосстрах:</strong> ".$price_1."</p>\r\n";
$msg .= "<p><strong>Цена Ренессанс:</strong> ".$price_2."</p>\r\n";
$msg .= "<p><strong>Цена АльфаСтрахование:</strong> ".$price_3."</p>\r\n";
$msg .= "</body></html>";
